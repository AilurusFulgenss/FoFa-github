...
} from "./chunk-BFDZT5PC.js";
import {
  QueryClient,
  QueryClientProvider,
  img
} from "./chunk-2ZKIUJSA.js";
import {
...
import {
  GuidedTourProvider,
  useGuidedTour
} from "./chunk-Q4IP25T4.js";
import {
  require_pick
} from "./chunk-I35BOS7J.js";
import {
  useEnterprise
} from "./chunk-WWVBOFW5.js";
import {
  Login
} from "./chunk-QIV3Q7EN.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-46P3A35Z.js";
import {
  ConfigurationProvider
} from "./chunk-3HM62LQ3.js";
import {
  require_baseMerge,
  require_createAssigner,
  require_merge,
  require_omit
} from "./chunk-P4PQUSP4.js";
import {
  require_baseRest
} from "./chunk-ESGR6FXM.js";
import {
  HistoryProvider
} from "./chunk-MIH6AJMO.js";
import {
  errorsTrads
...
import {
  ...
  create4 as create2,
  create6 as create3
} from "./chunk-4OWK5A6B.js";
import {
  TrackingProvider,
  useTracking
} from "./chunk-3Z62WSRR.js";
import {
  createAbsoluteUrl,
  useInitQuery
} from "./chunk-LISLDKDT.js";
import {
  getBasename
} from "./chunk-QIJGNK42.js";
import {
  useClipboard
} from "./chunk-667B5KXW.js";
import {
  ADMIN_PERMISSIONS_EE,
  getEERoutes
} from "./chunk-K2LV6WO2.js";
import {
  MemoizedInputRenderer
} from "./chunk-6NQFR5P6.js";
import {
  Form
} from "./chunk-OV2BHA57.js";
import {
  Layouts
} from "./chunk-SS6JV4SM.js";
import {
  getByteSize
...
} from "./chunk-X26EAOEV.js";
import {
  useTypedDispatch,
  useTypedSelector,
  useTypedStore
} from "./chunk-KXHIPKAZ.js";
import {
  adminApi,
  getFetchClient,
  isBaseQueryError,
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-QVE6ER5E.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-GOSYQZGD.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-32SBOJ26.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-WETFJENI.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-ZFUCW7FD.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-D7AOEYQ7.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-6S3QT66V.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-D3QI2YA4.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-GHSXJXOZ.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-2NY5BPRP.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-EBGWWGZW.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-SE6NTIG6.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-AIJ7KL5C.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-HZ2NHSWV.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-S2SNIXAI.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-Q32TTHGW.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-7SKAWLIE.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-42KRX2SP.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-PNGIE65U.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-HXPISF67.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-WAIU4VVN.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-MKYLQ5UF.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-B6OI6VXZ.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-LTUDFJRN.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-I3S2ZCSB.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-SS6VWRVR.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-PT25YXZV.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-NSC2VVUL.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-NEER5COI.js");
              return {
...
//# sourceMappingURL=chunk-EPPGO5TK.js.map
